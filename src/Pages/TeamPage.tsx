...
const TeamPage: React.FC = () => {
    ...
    },
    {
      ...
      members: [
        ...
        },
        {
          ...
          linkedIn:
            "https://www.linkedin.com/company/notion_vit/posts/?feedView=all",
        },
        {
          id: 3,
          name: "Ritika Singh",
  ...
  const activeTeamData =
    teamCategories.find((team) => team.id === activeTeam) || teamCategories[0];
    ...
    <div className="container mx-auto px-6 py-32 md:py-40">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-medium inter text-center mb-2">
            Faculty Coordinators
          </h2>
              ...
              >
                <div className="h-64 overflow-hidden relative">
                  ...
                  <img
                    ...
                    style={{
                      opacity:
                        loadingImages[`board-${member.id}`] === false ? 1 : 0,
                    }}
                  />
                </div>
                <div className="p-4 text-center">
              ...
              >
                <div className="h-48 sm:h-56 md:h-64 overflow-hidden relative">
                  ...
                  <img
                    ...
                    style={{
                      opacity:
                        loadingImages[`admin-${admin.id}`] === false ? 1 : 0,
                    }}
                  />
                </div>
                <div className="p-4 text-center">
        ...
        <section className="mb-10">
          <h2 className="text-3xl font-medium inter text-center mb-6">
            {activeTeamData.name}
          </h2>
          <div className="flex justify-center">
              ...
              >
                <div className="h-64 overflow-hidden relative">
                  ...
                  <img
                    ...
                    onError={() =>
                      handleImageError(`${activeTeam}-${member.id}`)
                    }
                    style={{
                      opacity:
                        loadingImages[`${activeTeam}-${member.id}`] === false

          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 text-white hover:opacity-90 transition-opacity hover:scale-110"
              >
                <Instagram size={20} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-green-500 text-white hover:opacity-90 transition-opacity hover:scale-110"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-blue-600 text-white hover:opacity-90 transition-opacity hover:scale-110"
              >
                <Linkedin size={20} />
              </a>
              <a
                href="mailto:notion@vitbhopal.ac.in?subject=Inquiry&body"
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-red-500 text-white hover:opacity-90 transition-opacity hover:scale-110"
              >
                <Mail size={20} />
              </a>
            </div>
